  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-bproduct" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-bproduct" class="form-horizontal">
...
<!--new options for product-->
                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="input-youtube<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                            <span data-toggle="tooltip" title="<?php echo $help_youtube; ?>">
                            <?php echo $entry_youtube; ?>
                            </span>
                            <div style="font-weight:normal;">
                                ...
                                (e.g. //www.youtube.com/embed/HfBRJYyyIgE?autoplay=1)
                            </div>
                        </label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="input-custom_title<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                            <span data-toggle="tooltip" title="<?php echo $help_custom_title; ?>">
                            <?php echo $entry_custom_title; ?>
                            </span>
                        </label>
                        <div class="col-sm-8">
                            <input type="text" name="product_description[<?php echo $language['language_id']; ?>][custom_title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['custom_title'] : ''; ?>" placeholder="<?php echo $entry_custom_title; ?>" id="input-custom_title<?php echo $language['language_id']; ?>" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="input-custom_description<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                            <?php echo $entry_description_custom; ?>
                        </label>
                        <div class="col-sm-8">
                            <textarea name="product_description[<?php echo $language['language_id']; ?>][custom_description]" placeholder="<?php echo $entry_description_custom; ?>" id="input-custom_description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['custom_description'] : ''; ?></textarea>
                        </div>
                    </div>
...
$('#input-custom_description<?php echo $language['language_id']; ?>').summernote({height: 300});
  <?php } ?>
//--></script> 
  <script type="text/javascript"><!--
// Manufacturer
...
$('input[name=\'related\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/bproduct/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
