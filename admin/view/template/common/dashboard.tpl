...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <?php } ?>
    <div class="row">
      <div class="col-lg-3 col-md-3 col-sm-6 dh_b1"><?php echo $order; ?></div>
      <div class="col-lg-3 col-md-3 col-sm-6 dh_b2"><?php echo $sale; ?></div>
      <div class="col-lg-3 col-md-3 col-sm-6 dh_b3"><?php echo $customer; ?></div>
      <div class="col-lg-3 col-md-3 col-sm-6 dh_b4"><?php echo $online; ?></div>
    </div>
    <div class="row">
