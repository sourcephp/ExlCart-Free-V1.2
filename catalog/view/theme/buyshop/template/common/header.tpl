...
<?php if (isset($theme_products["rollover_effect"]) && $theme_products["rollover_effect"] == '2' ) : ?>
    ...
    .product .product-image-wrapper a .view1 {backface-visibility: hidden; transform: rotateX(0deg) rotateY(0deg);transform-style: preserve-3d;transition: all 0.3s linear 0s; -webkit-transition: all .2s linear;transition: all .3s linear; -webkit-transform: rotateX(0deg) rotateY(0deg);-webkit-transform-style: preserve-3d;    -webkit-backface-visibility: hidden; -o-transition:all .2s linear; -ms-transition:all .2s linear; -moz-transition:all .2s linear; -webkit-transition:all .2s linear; transition:all .3s linear; -webkit-transform:rotateX(0deg) rotateY(0deg); -webkit-transform-style:preserve-3d; -webkit-backface-visibility:hidden; -moz-transform:rotateX(0deg) rotateY(0deg); -moz-transform-style:preserve-3d; -moz-backface-visibility:hidden
    }
    ...
    .product .product-image-wrapper a .view2{
        backface-visibility: hidden; left: 0; margin: 5px; position: absolute; top: 0; transform: rotateY(-180deg); transform-style: preserve-3d; transition: all 0.3s linear 0s; z-index: 100; -webkit-transition: all .4s linear; transition: all .3s linear; -webkit-transform: rotateY(-180deg); -webkit-transform-style: preserve-3d; -webkit-backface-visibility: hidden; -o-transition:all .4s linear; -ms-transition:all .4s linear; -moz-transition:all .4s linear; -webkit-transition:all .4s linear; transition:all .3s linear; -webkit-transform:rotateY(-180deg); -webkit-transform-style:preserve-3d; -webkit-backface-visibility:hidden; -moz-transform:rotateY(-180deg);-moz-transform-style:preserve-3d; -moz-backface-visibility:hidden
    }
    .product .product-image-wrapper a:hover .view2 {
        position: absolute; transform: rotateX(0deg) rotateY(0deg); z-index: 100; -webkit-transform:rotateX(0deg) rotateY(0deg); -moz-transform:rotateX(0deg) rotateY(0deg)
    }
...
?>
	...
	body{
        background-image: url("image/<?php echo $bioproduct_bgall; ?>"); background-repeat:<?php echo $theme_options["bgimage_mode"]; ?>; background-position:top center;
    }
<?php endif; ?>
/* end general tab */
...
<?php endif; ?>
        ...
        /* theme hover color*/
			...
			.shopping_cart_mini .button:hover,
             ...
             background-color:<?php echo $theme_colors["general_themehover"]?>!important;          <?php endif; ?>
             }
...
?>
	#content, section.all_pages,section.slider{
        background-image: url("image/<?php echo $bioproduct_contentbg; ?>"); background-repeat:<?php echo $theme_colors["content_bg_mode"]; ?>; background-position:top center;
    }
<?php endif; ?>
...
/* Footer popup: Background Color and Background Transparency  */
        ...
        #footer_popup, .footer_popup_dark{
            _background-color: <?php echo $theme_colors["footerpopup_bgcolor"]; ?>;     background-color: rgba(<?php echo $temp_popup[0]?>, <?php echo $temp_popup[1]?>, <?php echo $temp_popup[2]?>, <?php echo $theme_colors["footerpopup_bgtrans"]?>)
		}
        <?php
			} else {
		?>
            ...
            #footer_popup, .footer_popup_dark{
                _background-color: <?php echo $theme_colors["footerpopup_bgcolor"]; ?>;         background-color: rgba(<?php echo $temp_popup[0]?>, <?php echo $temp_popup[1]?>, <?php echo $temp_popup[2]?>, 0.85)}
...
?>
    .line, .line1, .promo_box{
        background: url("image/<?php echo $bioproduct_delimeter; ?>") repeat-x 0 0; border: medium none; height: 40px;
    }
<?php endif; ?>
...
<style type="text/css">
    ...
    .no_msie .animate-delay.animated.scale {
        -webkit-animation: scale 0.5s 1 cubic-bezier(0.445, 0.05, 0.55, 0.95); -moz-animation: scale 0.5s 1 cubic-bezier(0.445, 0.05, 0.55, 0.95); -o-animation: scale 0.5s 1 cubic-bezier(0.445, 0.05, 0.55, 0.95); animation: scale 0.5s 1 cubic-bezier(0.445, 0.05, 0.55, 0.95); opacity: 1;
    }

    .no_msie .animate.animated.pulse,
    .no_msie .animate-delay.animated.pulse {
        -webkit-animation: pulse 0.5s 1 linear; -moz-animation: pulse 0.5s 1 linear; -o-animation: pulse 0.5s 1 linear; animation: pulse 0.5s 1 linear; opacity: 1;
    }

    .no_msie .animate.animated.flip,
    .no_msie .animate-delay.animated.flip {
        -webkit-animation: flip 0.5s 1 linear; -moz-animation: flip 0.5s 1 linear; -o-animation: flip 0.5s 1 linear; animation: flip 0.5s 1 linear; -webkit-backface-visibility: visible !important; -ms-backface-visibility: visible !important; backface-visibility: visible !important; opacity: 1;
    }
    .no_msie .animate.animated.fadeUp,
    .no_msie .animate-delay.animated.fadeUp {
        -webkit-animation: fadeUp 0.5s 1 linear; -moz-animation: fadeUp 0.5s 1 linear; -o-animation: fadeUp 0.5s 1 linear; animation: fadeUp 0.5s 1 linear; opacity: 1;
    }
...
<!--custom css changes-->
<?php if (isset($theme_options["css_file"]) && $theme_options["css_file"] == 1) : ?>
...
<script src="catalog/view/theme/<?php echo $config->get('config_template'); ?>/js/jquery-latest.min.js"></script>
<script src="catalog/view/theme/<?php echo $config->get('config_template'); ?>/js/jquery-migrate-1.2.1.js"></script>
    ...
    <div class="container">
        ...
        <div class="wrapper">
            <div class="logo-invert">
                <?php
                $logo_popup = $config->get('bioproduct_contactimg');         if ($logo_popup !== '' ):
                ?>
                    ...
                    <span class="login_social">
                         <?php
                            if (!$logged && isset($theme_options[$lang]["welcome_not_registered"]) && $theme_options[$lang]["welcome_not_registered"] !== '') {
                               echo html_entity_decode($theme_options[$lang]["welcome_not_registered"], ENT_QUOTES, 'UTF-8');                     } elseif (isset($theme_options[$lang]["welcome_registered"]) && $theme_options[$lang]["welcome_registered"] !== '') {
...
<!-- small menu -->
        <nav class="barred_menu">
            <ul class="nav nav-list">
                            ...
                            <ul class="open_block collapse7" id="level<?php echo $level_count; ?>">
                                <?php
                                        for ($i = 0; $i < count($category['children']);) {
                                            $j = $i + ceil(count($category['children']) / 1);                                     for (; $i < $j; $i++) {
             ...
             if (isset($theme_options[$lang]["contacts_link_title"]) && $theme_options[$lang]["contacts_link_title"] !== '' ) {
                 echo $theme_options[$lang]["contacts_link_title"];      } else {echo 'pages';}
         ?>
                            </a>
                            ...
                            <ul class="open_block collapse7" id="level_pages">
                                <?php
                                global $loader, $registry;                         $loader->model('catalog/information');                         $model = $registry->get('model_catalog_information');                         $informations = $model->getInformations();

                                    if (isset($informations)) :
                                        foreach ($informations as $information) :
                                            global $url;                                     $information_href = $url->link('information/information', 'information_id=' . $information['information_id']);
                        ...
                        <li>
                            ...
                            <?php
                             if (isset($theme_options[$lang]["customitem_item_title2"]) && $theme_options[$lang]["customitem_item_title2"] !== '' ) {
                                 echo html_entity_decode($theme_options[$lang]["customitem_item_title2"], ENT_QUOTES, 'UTF-8');                      } else {echo 'BUY NOW<span class="pulse-button">!</span>';}
                        ?>
                            </a>
                        </li>
                        <?php endif; ?>
                        ...
                        <span>
                            ...
                            <?php
                                if (isset($theme_options[$lang]["blog_link_title"]) && $theme_options[$lang]["blog_link_title"] !== '' ) {
                                    echo $theme_options[$lang]["blog_link_title"];                         } else {echo 'Blog';}
                            ?>
        ...
        <nav class="hidden-phone main_menu">
            ...
            <ul id="nav" class="menu megamenu">
                ...
                <?php
                            $loader->model('custom/general');         $model = $registry->get('model_custom_general');

                $category_id = $model->getCurrentMenuCategory($category["href"]);         $category_topmenu = $model->getCategoryOption($category_id,'topmenu');
                ...
                <li class="level0 last parent dropdown menu_catalog_link item_pages">
                    ...
                    <?php if ($category['children']) : ?>
                    <ul class="level0 level_margin <?php echo ($category['column'] < 2 || !isset($category_topmenu) || $category_topmenu == '' ? 'one-column' : ''); ?>">
                        <li>
                            <ul class="shadow">
                                <li class="row_middle">
                                    <ul class="rows_outer">
                    ...
                    <a <?php if ($theme_options["customitem_item_url1"] !== '' ) :?> href="<?php echo $theme_options["customitem_item_url1"]; ?>" <?php endif; ?>>
                                                        <span>
                                                            <?php if (isset($theme_options[$lang]["customitem_item_title1"]) && $theme_options[$lang]["customitem_item_title1"] !== '' ) {
                                                                echo $theme_options[$lang]["customitem_item_title1"];                                                      } else {echo 'Custom Block';}
                                                             ?>
                                                        </span>
                    </a>
                    ...
                    <a class="contact-button" href="index.php?route=information/contact">
                                        <?php
                                                if (isset($theme_options[$lang]["contact_map_title"]) && $theme_options[$lang]["contact_map_title"] !== '' ) {
                                                    echo $theme_options[$lang]["contact_map_title"];                                         } else {echo 'CONTACT';}
                                            ?>
                    </a>
                </li>
                <?php endif;*/ ?>
