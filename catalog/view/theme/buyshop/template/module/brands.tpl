        ...
        <div class="span12">
            ...
            <div class="brands_block" id="brands<?php echo $module; ?>">
                <ul class="jcarousel-skin-brands">
                    ...
                    <li><a href="<?php echo $banner['link']; ?>"><img src="<?php echo $banner['image']; ?>" data-image2x="<?php echo $banner['image2x']; ?>" alt="<?php echo $banner['title']; ?>" title="<?php echo $banner['title']; ?>" /></a></li>
                    <?php } ?>
                </ul>
            </div>
        </div>
