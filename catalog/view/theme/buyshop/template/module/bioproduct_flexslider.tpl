<?php
global $config;
$flexslider_settings = $config->get('bioproduct_flexslider');
$slider_width_settings = $config->get('bioproduct_additional');
  ...
  jQuery(document).ready(function() {
      ...
      var flexSliderTop = $(".flexslider.big");
          ...
          flexSliderTop.flexslider({
                  <?php if (isset($flexslider_settings["flexslider_nav"])) { ?>
          directionNav: <?php echo ($flexslider_settings["flexslider_nav"] == 0 ? 'false' : 'true'); ?>,
      <?php } ?>
      <?php if (isset($flexslider_settings["flexslider_direction"])) { ?>
          direction: "<?php echo $flexslider_settings["flexslider_direction"]; ?>",
      <?php } ?>
      <?php if (isset($flexslider_settings["flexslider_animationspeed"])) { ?>
          animationSpeed: <?php echo $flexslider_settings["flexslider_animationspeed"]; ?>,
      <?php } ?>
      <?php if (isset($flexslider_settings["flexslider_slideshowspeed"])) { ?>
          slideshowSpeed: <?php echo $flexslider_settings["flexslider_slideshowspeed"]; ?>,
      <?php } ?>
      <?php if (isset($flexslider_settings["flexslider_control"])) { ?>
          controlNav: <?php echo ($flexslider_settings["flexslider_control"] == 0 ? 'false' : 'true'); ?>,
      <?php } ?>
      <?php if (isset($flexslider_settings["flexslider_animation"])) { ?>
            ...
            <ul class="slides">
                ...
                <li style="position: relative;">
                    ...
                    <a href="<?php echo $banner['link']; ?>">
                        <img data-retina="true" src="<?php echo $banner['image']; ?>" alt="<?php echo $banner['title']; ?>" />
                    </a>
                    <?php } else { ?>
                        <img data-retina="true" src="<?php echo $banner['image']; ?>" alt="<?php echo $banner['title']; ?>" />
                    <?php } ?>
